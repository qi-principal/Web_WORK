      ...
      <div style="padding: 15px 20px">
        <el-row :gutter="20">
          ...
          <el-col :span="12" style="margin-top: 20px">
            ...
            <div style="color: #666666FF; margin-top: 20px">销量：{{goodsData.count}}</div>
            <div style="color: red; margin-top: 20px">疯抢价：<span style="font-size: 20px">{{goodsData.price}} / {{goodsData.unit}}</span></div>
<!--            <div style="color: #666666FF; margin-top: 20px">商家：<a href="#" @click="navTo('/front/business?id=' + goodsData.businessId)">{{goodsData.businessName}}</a></div>-->
            ...
            <div style="color: #666666FF; margin-top: 20px">
              <el-button type="warning" @click="addCart" style="margin-top: 20px">加入购物车</el-button>
